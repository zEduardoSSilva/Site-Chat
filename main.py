...
if __name__ == "__main__":
    socketio.run(app, host="192.168.15.7", allow_unsafe_werkzeug=True) # define que o app vai rodar no seu servidor local, ou seja, na internet em que o seu computador tá conectado
